...
W = 65;             // Outer width of the box
H_box = 35;         // Height of the bottom box part
...
lip_offset = 1.5;   // Thickness/offset of the inner lip

// --- Mounting Posts ---
post_R = 4.5;       // Radius of the solid screw posts in the corners
hole_R = 1.5;       // Radius of the screw hole (e.g., 1.5 for an M3 screw)
head_R = 3.2;       // Radius for the countersunk screw head in the lid
fillet_R = 2;       // Radius of the smooth fillet between posts and walls
